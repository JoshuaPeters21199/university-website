...
export default function UVUCreateCourseForm() {
    ...
    useEffect(() => {
        const fetchTeachers = async () => {
            try {
                const res = await fetch('/api/uvuTeachers');
    ...
    useEffect(() => {
        const fetchTas = async () => {
            try {
                const res = await fetch('/api/uvuTas');
